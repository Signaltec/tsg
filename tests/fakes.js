...
// Fill portX series
var interval = 1000 * 60 * 1; // раз в 30 мин
var ports = 8;
var points = (1000 * 60 * 60 * 24) * 1 / interval;

points = 400;
  
var t = new Date();
t = new Date(t.getTime() - interval * points/2  );
...
for (var i = 0; i < points; i++) {
      ...
      for(var j = 1; j < ports + 1; j++) {
        ...
        var point = {rx : rx[j], tx: 0, crc: crc[j], drops: drops[j], time: t};
